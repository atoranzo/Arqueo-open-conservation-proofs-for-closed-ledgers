...
**286 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **980 tests en la compuerta de sello** —286 de la capa, 318 de
  ...
  cable y el puente ISO—, **1117 contando los pines de `--largo` y
  `--completo`**, y **1131 declarados**. 0 fallos y 24
