...
**272 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **960 tests en la compuerta de sello** —272 de la capa, 312 de
  ...
  cable y el puente ISO—, **1097 contando los pines de `--largo` y
  `--completo`**, y **1111 declarados**. 0 fallos y 24
