...
- **736 tests en la compuerta de sello** —257 de la capa, 297 de
  ...
  cable y el puente ISO—, **873 contando los pines de `--largo` y
  `--completo`**, y **887 declarados**. 0 fallos y 24
