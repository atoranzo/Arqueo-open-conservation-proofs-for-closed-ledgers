...
- **1131 tests en la compuerta de sello** —345 de la capa, 330 de
  ...
  cable y el puente ISO—, **1268 contando los pines de `--largo` y
  `--completo`**, y **1284 declarados**. 0 fallos y 24
