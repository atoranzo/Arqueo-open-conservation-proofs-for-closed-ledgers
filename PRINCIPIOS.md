...
**350 tests** (5 ignorados, declarados) en `crates/zk-ssl`.
...
- **1153 tests en la compuerta de sello** —350 de la capa, 338 de
  ...
  cable y el puente ISO—, **1290 contando los pines de `--largo` y
  `--completo`**, y **1306 declarados**. 0 fallos y 24
