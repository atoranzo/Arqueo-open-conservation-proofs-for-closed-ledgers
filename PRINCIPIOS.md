...
- **1175 tests en la compuerta de sello** —357 de la capa, 348 de
  ...
  cable y el puente ISO—, **1312 contando los pines de `--largo` y
  `--completo`**, y **1330 declarados**. 0 fallos y 24
