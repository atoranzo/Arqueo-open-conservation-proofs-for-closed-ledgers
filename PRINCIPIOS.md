...
**398 tests** (7 ignorados, declarados) en `crates/zk-ssl`.
...
- **1311 tests en la compuerta de sello** —398 de la capa, 390 de
  ...
  cable y el puente ISO—, **1448 contando los pines de `--largo` y
