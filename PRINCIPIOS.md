...
- **907 tests en la compuerta de sello** —264 de la capa, 297 de
  ...
  cable y el puente ISO—, **1044 contando los pines de `--largo` y
  `--completo`**, y **1058 declarados**. 0 fallos y 24
