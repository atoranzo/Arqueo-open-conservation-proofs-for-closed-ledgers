...
**292 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **986 tests en la compuerta de sello** —292 de la capa, 318 de
  ...
  cable y el puente ISO—, **1123 contando los pines de `--largo` y
  `--completo`**, y **1137 declarados**. 0 fallos y 24
