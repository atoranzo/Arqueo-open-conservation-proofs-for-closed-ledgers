...
- **775 tests en la compuerta de sello** —257 de la capa, 297 de
  circuitos, **79 del nodo**, 34 de la ceremonia, 17 de liquidación, **33
  del verificador independiente**, **26 del testigo**, y los del SDK, el
  cable y el puente ISO—, **912 contando los pines de `--largo` y
  `--completo`**, y **926 declarados**. 0 fallos y 24
