...
**354 tests** (6 ignorados, declarados) en `crates/zk-ssl`.
...
- **1157 tests en la compuerta de sello** —354 de la capa, 338 de
  ...
  cable y el puente ISO—, **1294 contando los pines de `--largo` y
  `--completo`**, y **1311 declarados**. 0 fallos y 24
