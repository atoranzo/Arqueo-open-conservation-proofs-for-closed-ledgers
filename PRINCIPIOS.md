...
- **1057 tests en la compuerta de sello** —323 de la capa, 318 de
  ...
  cable y el puente ISO—, **1194 contando los pines de `--largo` y
  `--completo`**, y **1208 declarados**. 0 fallos y 24
