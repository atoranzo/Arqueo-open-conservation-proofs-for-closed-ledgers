...
- **926 tests en la compuerta de sello** —264 de la capa, 297 de
  ...
  cable y el puente ISO—, **1063 contando los pines de `--largo` y
  `--completo`**, y **1077 declarados**. 0 fallos y 24
