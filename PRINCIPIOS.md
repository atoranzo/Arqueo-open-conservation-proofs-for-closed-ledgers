...
**330 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **1095 tests en la compuerta de sello** —330 de la capa, 318 de
  ...
  cable y el puente ISO—, **1232 contando los pines de `--largo` y
  `--completo`**, y **1246 declarados**. 0 fallos y 24
