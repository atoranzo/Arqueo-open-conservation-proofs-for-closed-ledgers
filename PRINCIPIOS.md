...
- **957 tests en la compuerta de sello** —269 de la capa, 312 de
  ...
  cable y el puente ISO—, **1094 contando los pines de `--largo` y
  `--completo`**, y **1108 declarados**. 0 fallos y 24
