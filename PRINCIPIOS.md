...
**344 tests** (5 ignorados, declarados) en `crates/zk-ssl`.
...
- **1130 tests en la compuerta de sello** —344 de la capa, 330 de
  circuitos, **108 del nodo**, 34 de la ceremonia, 17 de liquidación, **104
  del verificador independiente**, **100 del testigo**, y los del SDK, el
  cable y el puente ISO—, **1267 contando los pines de `--largo` y
  `--completo`**, y **1283 declarados**. 0 fallos y 24
