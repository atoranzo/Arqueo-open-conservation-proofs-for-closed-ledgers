...
**285 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **979 tests en la compuerta de sello** —285 de la capa, 318 de
  ...
  cable y el puente ISO—, **1116 contando los pines de `--largo` y
  `--completo`**, y **1130 declarados**. 0 fallos y 24
