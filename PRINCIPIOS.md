...
- **816 tests en la compuerta de sello** —263 de la capa, 297 de
  circuitos, **82 del nodo**, 34 de la ceremonia, 17 de liquidación, **48
  del verificador independiente**, **39 del testigo**, y los del SDK, el
  cable y el puente ISO—, **953 contando los pines de `--largo` y
  `--completo`**, y **967 declarados**. 0 fallos y 24
