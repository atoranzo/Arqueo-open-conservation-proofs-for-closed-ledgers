...
- **1135 tests en la compuerta de sello** —345 de la capa, 330 de
  ...
  cable y el puente ISO—, **1272 contando los pines de `--largo` y
  `--completo`**, y **1288 declarados**. 0 fallos y 24
