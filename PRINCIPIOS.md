...
**259 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **777 tests en la compuerta de sello** —259 de la capa, 297 de
  ...
  cable y el puente ISO—, **914 contando los pines de `--largo` y
  `--completo`**, y **928 declarados**. 0 fallos y 24
