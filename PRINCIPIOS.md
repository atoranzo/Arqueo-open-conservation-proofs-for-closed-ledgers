...
**335 tests** (4 ignorados, declarados) en `crates/zk-ssl`.
...
- **1100 tests en la compuerta de sello** —335 de la capa, 318 de
  ...
  cable y el puente ISO—, **1237 contando los pines de `--largo` y
  `--completo`**, y **1252 declarados**. 0 fallos y 24
