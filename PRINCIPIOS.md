...
**289 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **983 tests en la compuerta de sello** —289 de la capa, 318 de
  ...
  cable y el puente ISO—, **1120 contando los pines de `--largo` y
  `--completo`**, y **1134 declarados**. 0 fallos y 24
