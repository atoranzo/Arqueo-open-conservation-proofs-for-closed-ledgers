...
**265 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **938 tests en la compuerta de sello** —265 de la capa, 297 de
  ...
  cable y el puente ISO—, **1075 contando los pines de `--largo` y
  `--completo`**, y **1089 declarados**. 0 fallos y 24
