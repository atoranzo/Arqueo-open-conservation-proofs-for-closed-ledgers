...
- **949 tests en la compuerta de sello** —269 de la capa, 304 de
  ...
  cable y el puente ISO—, **1086 contando los pines de `--largo` y
  `--completo`**, y **1100 declarados**. 0 fallos y 24
