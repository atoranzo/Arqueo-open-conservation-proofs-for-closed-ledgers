...
**276 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **964 tests en la compuerta de sello** —276 de la capa, 312 de
  ...
  cable y el puente ISO—, **1101 contando los pines de `--largo` y
  `--completo`**, y **1115 declarados**. 0 fallos y 24
