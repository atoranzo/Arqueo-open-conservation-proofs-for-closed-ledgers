...
**287 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **981 tests en la compuerta de sello** —287 de la capa, 318 de
  ...
  cable y el puente ISO—, **1118 contando los pines de `--largo` y
  `--completo`**, y **1132 declarados**. 0 fallos y 24
