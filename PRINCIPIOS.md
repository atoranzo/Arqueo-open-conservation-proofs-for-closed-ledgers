...
- **850 tests en la compuerta de sello** —264 de la capa, 297 de
  circuitos, **73 del nodo**, 34 de la ceremonia, 17 de liquidación, **55
  del verificador independiente**, **59 del testigo**, y los del SDK, el
  cable y el puente ISO—, **987 contando los pines de `--largo` y
  `--completo`**, y **1001 declarados**. 0 fallos y 24
