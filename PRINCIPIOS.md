...
**294 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **988 tests en la compuerta de sello** —294 de la capa, 318 de
  ...
  cable y el puente ISO—, **1125 contando los pines de `--largo` y
  `--completo`**, y **1139 declarados**. 0 fallos y 24
