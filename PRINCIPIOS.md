...
- **868 tests en la compuerta de sello** —264 de la capa, 297 de
  ...
  cable y el puente ISO—, **1005 contando los pines de `--largo` y
  `--completo`**, y **1019 declarados**. 0 fallos y 24
