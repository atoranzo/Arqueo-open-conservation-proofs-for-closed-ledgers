...
- **944 tests en la compuerta de sello** —269 de la capa, 299 de
  ...
  cable y el puente ISO—, **1081 contando los pines de `--largo` y
  `--completo`**, y **1095 declarados**. 0 fallos y 24
