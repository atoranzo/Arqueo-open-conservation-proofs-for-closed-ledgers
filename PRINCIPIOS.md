...
**301 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **995 tests en la compuerta de sello** —301 de la capa, 318 de
  ...
  cable y el puente ISO—, **1132 contando los pines de `--largo` y
  `--completo`**, y **1146 declarados**. 0 fallos y 24
