...
**284 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **978 tests en la compuerta de sello** —284 de la capa, 318 de
  ...
  cable y el puente ISO—, **1115 contando los pines de `--largo` y
  `--completo`**, y **1129 declarados**. 0 fallos y 24
