...
- **678 tests en la compuerta de sello** —256 de la capa, 297 de
  circuitos, **40 del nodo**, 34 de la ceremonia, 17 de liquidación, **12
  del verificador independiente**, **11 del testigo**, y los del SDK, el
  cable y el puente ISO—, **815 contando los pines de `--largo` y
  `--completo`**, y **829 declarados**. 0 fallos y 24
