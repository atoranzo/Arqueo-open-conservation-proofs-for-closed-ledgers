...
- **842 tests en la compuerta de sello** —263 de la capa, 297 de
  ...
  cable y el puente ISO—, **979 contando los pines de `--largo` y
  `--completo`**, y **993 declarados**. 0 fallos y 24
