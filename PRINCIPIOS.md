...
**421 tests** (7 ignorados, declarados) en `crates/zk-ssl`.
...
- **1434 tests en la compuerta de sello** —421 de la capa, 403 de
  circuitos, **125 del nodo**, 34 de la ceremonia, 17 de liquidación, **121
  del verificador independiente**, **124 del testigo**, y los del SDK, el
  cable, el puente ISO y el fork de winterfell—, **1571 contando los pines
