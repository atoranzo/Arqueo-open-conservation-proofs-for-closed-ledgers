...
- **703 tests en la compuerta de sello** —256 de la capa, 297 de
  ...
  cable y el puente ISO—, **840 contando los pines de `--largo` y
  `--completo`**, y **854 declarados**. 0 fallos y 24
