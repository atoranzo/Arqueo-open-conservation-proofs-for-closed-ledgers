...
- **782 tests en la compuerta de sello** —259 de la capa, 297 de
  ...
  cable y el puente ISO—, **919 contando los pines de `--largo` y
  `--completo`**, y **933 declarados**. 0 fallos y 24
