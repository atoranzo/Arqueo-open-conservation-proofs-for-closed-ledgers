...
- **913 tests en la compuerta de sello** —264 de la capa, 297 de
  circuitos, **84 del nodo**, 34 de la ceremonia, 17 de liquidación, **66
  del verificador independiente**, **81 del testigo**, y los del SDK, el
  cable y el puente ISO—, **1050 contando los pines de `--largo` y
  `--completo`**, y **1064 declarados**. 0 fallos y 24
