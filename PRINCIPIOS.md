...
**304 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **998 tests en la compuerta de sello** —304 de la capa, 318 de
  ...
  cable y el puente ISO—, **1135 contando los pines de `--largo` y
  `--completo`**, y **1149 declarados**. 0 fallos y 24
