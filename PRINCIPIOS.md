...
**329 tests** (3 ignorados, declarados) en `crates/zk-ssl`.
...
- **1086 tests en la compuerta de sello** —329 de la capa, 318 de
  circuitos, **104 del nodo**, 34 de la ceremonia, 17 de liquidación, **96
  del verificador independiente**, **100 del testigo**, y los del SDK, el
  cable y el puente ISO—, **1223 contando los pines de `--largo` y
  `--completo`**, y **1237 declarados**. 0 fallos y 24
