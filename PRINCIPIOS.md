...
- **790 tests en la compuerta de sello** —262 de la capa, 297 de
  ...
  cable y el puente ISO—, **927 contando los pines de `--largo` y
  `--completo`**, y **941 declarados**. 0 fallos y 24
