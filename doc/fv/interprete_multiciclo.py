...
def main():
    ...
    if mut is None:
        ...
        if nuevas:
            ...
            print("      — lo ven las DOS redes del guardián (ranuras MUERTAS y periódicas sin")
            print("        leerse), que hoy avisan como huecos sin tumbar el exit: la compuerta")
            print("        del rito cae porque la línea limpia del resumen desaparece")
        else:
