...
Sexta pieza de la estirpe FV-1; derivado ANCLADO del intérprete de mint.
El drift medido antes de derivar: 11/12 anclas idénticas — recovery
construye first_row por asignación directa (el corte lo absorbe; la
máscara {0} no cambia). El sujeto es circuit_recovery_climb: periódicas de longitud-de-traza (512 filas)
...
def main():
    ...
    print("== intérprete multi-ciclo: circuit_recovery_climb · %d columnas · %d pasos ==" %
    ...
    if mut is None:
        ...
        if nuevas:
            ...
            print("   ✅ al censo se le escapa (Horner co-posee la col 38 en las clases de cierre)")
    ...
    print("COMPUERTA-RECOVERY: %d clases · %d celdas-clase · %d libres declaradas · %d sin dueño · "
