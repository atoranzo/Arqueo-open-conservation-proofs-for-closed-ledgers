...
comparación— en vez de 192 bytes cambia el tamaño del ledger
persistente, los tiempos de sincronización entre nodos y la validación
en frío en dos órdenes de magnitud.
