...
| `openrpc.json` | the same API as a machine-readable OpenRPC 1.2.6 document: `info.version` is `zkssl/0.4` and it lists 30 methods (27 `zkssl_*`, 3 `dev_*`) | you generate a client or check a node's surface |
