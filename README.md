...
| **Protocolo `zkssl/0.3`**: 29 métodos JSON-RPC (26 `zkssl_*`, 3 `dev_*`), OpenRPC generado desde el código, vectores por versión que jamás se reescriben | [`spec/RPC.md`](./spec/RPC.md) · [`spec/openrpc.json`](./spec/openrpc.json) · [`spec/vectors/`](./spec/vectors/) (240 ficheros: cable, núcleo, paquete, consumo, conflicto, rechazo, edad y los tres `zkssl-0.N.json`) |
