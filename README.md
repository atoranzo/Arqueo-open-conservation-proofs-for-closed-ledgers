...
| **Protocolo `zkssl/0.4`**: 30 métodos JSON-RPC (27 `zkssl_*`, 3 `dev_*`), OpenRPC generado desde el código, vectores por versión que jamás se reescriben | [`spec/RPC.md`](./spec/RPC.md) · [`spec/openrpc.json`](./spec/openrpc.json) · [`spec/vectors/`](./spec/vectors/) (317 ficheros: cable, núcleo, paquete, consumo, conflicto, rechazo, edad, pendiente, pago, prenda, los catálogos 0.3 bajo `0.3/` y los cuatro `zkssl-0.N.json`) |
