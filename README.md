...
| **RFC**: 0002, 0003, 0004, 0006, 0007 (las pruebas sobre el estado comprometido) y 0009 (lo que revela una prueba) aceptados; 0005 (el núcleo congelado) y 0008 (las pruebas portables del pendiente) propuestos | [`spec/rfc/`](./spec/rfc/) |
