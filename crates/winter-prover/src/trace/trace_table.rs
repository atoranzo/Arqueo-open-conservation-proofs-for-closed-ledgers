...
impl<B: StarkField> TraceTable<B> {
    ...
    /// or is not a power of two.
    // ARQUEO (AUDITORIA 533): el lifetime explicito, como en la variante concurrent; rustc 1.97
    // avisa (mismatched_lifetime_syntaxes) y el canon no admite avisos en un miembro.
