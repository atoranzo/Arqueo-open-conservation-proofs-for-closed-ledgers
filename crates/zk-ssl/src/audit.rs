...
//! clave maestra que robar. Hasta el §538 la prueba publicaba la clave de gasto y
//! el saldo exacto (§523); el supervisor depende de la cooperación del titular.
use super::*;
...
impl SovereignLayer {
    ...
    ///
    /// Demuestra `inferior <= saldo <= superior` sobre el estado actual. **Oculta
    /// el testigo desde el §538**: hasta entonces la prueba publicaba la clave de
    /// gasto y el saldo exacto (§523), en los tres usos:
    ///
    ...
    ///
    /// Requiere la clave de gasto: **solo el titular puede revelar**; hasta el
    /// §538, al revelar la entregaba (§523). Es revelación voluntaria, no custodia
    /// de claves: no hay ninguna clave maestra que robar.
    pub fn audit(
        &self,
