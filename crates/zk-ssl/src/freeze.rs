...
impl SovereignLayer {
    ...
    /// Congela o descongela sin que las claves de custodio lleguen como dato al operador
    /// -hasta el §538 cada prueba publicaba la suya (§523)-: la via de la entrada 32/33 (§60).
    ///
    ...
    pub fn apply_freeze_delegated(
        ...
        crate::comprobar_forma(
            ...
            stark_experiment::circuit_frozen_climb::TRACE_WIDTH,
            0,
            0,
        ...
        self.log.append_con_compromiso(OpKind::Freeze, raiz, raiz, &crate::log::sello_de_autorizacion(&operation), operation);
        self.commit(&[], None)?;
        Ok(())
    }
}
...
mod tests_delegada {
    ...
    /// claves como dato; hasta el §538 cada prueba publicaba la suya (§523).
    #[test]
