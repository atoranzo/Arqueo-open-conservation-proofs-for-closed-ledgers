...
//!
//! Desde el §538 las pruebas ocultan su testigo (antes no: §521, §523), y garantizan esto:
//!
...
//! | Emitir sin autorización | Dos custodios demostrados en circuito (ante el operador: §538) |
