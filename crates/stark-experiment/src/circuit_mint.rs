...
//! máquina— pide delegar la prueba. Hasta el §538 cada prueba delegada publicaba la
//! clave de su custodio y el nodo juntaba dos (§523); desde el §538 no la publica literal.
//!
