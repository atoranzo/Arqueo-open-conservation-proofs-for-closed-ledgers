...
mod tests {
    ...
    #[test]
    // ✅ **Estaba ROJO y paso a VERDE con el arreglo de §74.** Se le quita la
    // marca, que es lo que §50 dejo dicho que se hace con un testigo cuando
    // el fallo que nombra se corrige. Se queda como regresion permanente.
