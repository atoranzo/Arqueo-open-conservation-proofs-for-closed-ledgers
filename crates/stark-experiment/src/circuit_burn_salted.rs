//! ⚠️ **ANDAMIO B13/B14 — GEMELO del mundo nuevo (paso 3, §145).**
//!
//! Copia declarada de `circuit_burn` donde vive su migración — hoja
//! envuelta, frozen-32 local y las mutaciones obligatorias — por el
//! playbook (`doc/playbook-replica-gemelos.md`). ⚠️ PRIMER DESBORDE de
//! la campaña: el legacy cabe en 512 filas, el mundo nuevo llega a la
//! 543 — este gemelo nace con `TRACE_LENGTH = 1024` (spec §3: decisión
//! por circuito con el dato delante; coste ~2× de su prueba, a medir
//! en el paso 5).
//!
//! **Cláusula de retirada**: en el flip (release única, D4) este módulo
//! SUSTITUYE a `circuit_burn` y el legacy se borra. Hasta entonces,
