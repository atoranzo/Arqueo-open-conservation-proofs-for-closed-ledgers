...
17 crates en Rust con canon en cada cambio; protocolo `zkssl/0.3` con 28 métodos y vectores que no
...
17 crates in Rust with the canon on every change; protocol `zkssl/0.3` with 28 methods and vectors
