...
18 crates en Rust con canon en cada cambio; protocolo `zkssl/0.3` con 29 métodos y vectores que no
...
18 crates in Rust with the canon on every change; protocol `zkssl/0.3` with 29 methods and vectors
