...
`crates/zk-ssl` — **421 tests** (7 ignorados, declarados). Material para
...
**Mil transferencias: ~620 s de prueba y 139,2 a 160,2 MiB acumulados.** Ese es el
...
> del sistema**. La capa es `zk-ssl`: 33 módulos y **421 tests**, frente a
...
depuración da 188 pasan, 93 fallan y 9 ignorados; en release, 307 pasan, 0
