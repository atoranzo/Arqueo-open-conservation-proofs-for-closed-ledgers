...
`crates/zk-ssl` — **304 tests** (3 ignorados, declarados). Material para
...
> del sistema**. La capa es `zk-ssl`: 22 módulos y **304 tests**, frente a
...
depuración da 188 pasan, 93 fallan y 9 ignorados; en release, 304 pasan, 0
