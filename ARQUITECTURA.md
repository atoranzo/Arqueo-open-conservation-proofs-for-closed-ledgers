...
`crates/zk-ssl` — **301 tests** (3 ignorados, declarados). Material para
...
> del sistema**. La capa es `zk-ssl`: 22 módulos y **301 tests**, frente a
...
depuración da 188 pasan, 93 fallan y 9 ignorados; en release, 301 pasan, 0
