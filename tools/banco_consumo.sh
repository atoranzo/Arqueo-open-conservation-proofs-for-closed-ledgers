...
# RFC-0007 E1b (§452): el nodo emite v5, y el sobre de consumo acepta v4, v5 o v6 (el mando lo deriva).
case "$(qnum "$FV_V")" in 4|5|6) : ;; *) fallo "la cabeza vieja dice formatVersion $(qnum "$FV_V"): el sobre de consumo exige cabezas v4, v5 o v6 (una v2 o v3 no lleva consRoot)";; esac
...
case "$(qnum "$FV_N")" in 4|5|6) : ;; *) fallo "la cabeza nueva dice formatVersion $(qnum "$FV_N"): el sobre exige cabezas v4, v5 o v6";; esac
