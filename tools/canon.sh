...
TABLA=$(cat <<'FIN_TABLA'
zk-ssl             sello     323   3   0   600  alias=capa · la capa · §292: 262 -> 263, la cima en el digest · §304: 263 -> 264, el atado de la cifra publicada · §340: 264 -> 265, la altura entra en el digest · §345: 265 -> 269, el compositor v2 (RFC-0003, E1a) · §350: 269 -> 272, el cobro aprende el sobre (E3b-1 del RFC-0003) · §351: 272 -> 276, la apertura en el recibo (E3b-2 del RFC-0003) · §353: 276 -> 279, la via viva aprende el sobre (E3c-1b del RFC-0003) · §355: 279 -> 284, la guarda de ancho llega a los gemelos · §357: 284 -> 285, el testigo funcional de la des-emision (deuda del §351) · §359: 285 -> 286, el export del snapshot falla cerrado · §362: 286 -> 287, el reloj sale del atado a su contrato propio · §379: 287 -> 289, la conservacion del dinero se comprueba al abrir · §387: 289 -> 292, la raiz del pendiente se guarda y se comprueba al abrir · §388: 292 -> 294, la raiz de meta del pendiente se guarda y se comprueba al abrir · §390: 294 -> 295, descongelar sobrevive al reinicio · §391: 295 -> 298, la raiz de congelados en reposo · §392: 298 -> 301, la raiz del registro en reposo · §393: 301 -> 304, los contadores custodiados los deriva el registro · §394: 304 -> 307, la cuota de custodios la deriva el registro · §413: 307 -> 317, el consumo publicado (RFC-0006, E1) · §415: 317 -> 318, la pareja de consumos en el digest (RFC-0006, E2b) · §416: 318 -> 323, el camino del consumo (RFC-0006, E3a)
...
zk-ssl-wire        sello      17   0   0    60  §259: 20 metodos, y el json publicado atado a la tabla · §311: 3 -> 7, el DTO de la cabeza firmada · §312: 7 -> 10, el accesor falible de la cabeza firmada · §313: 10 -> 13, los tres constructores nombrados · §315: 13 -> 15, la cofirma en el cable · §415: 15 -> 17, la cabeza v4 en el cable y la vista por version (RFC-0006, E2b)
zk-ssl-cli         sello      97   0   0   120  alias=testigo · §250: 22 -> 26, la vista dividida EN FRIO · §294: 28 -> 39, la historia como segundo canal · §295: 39 -> 43, el banco del consumidor · §299: 43 -> 51, el cofirmante del testigo · §300: 51 -> 54, el mando de la cofirma · §301: 54 -> 58, la herramienta del tercero · §310: 58 -> 59, la serie de cofirmas es por testigo · §312: 59 -> 61, el testigo consume la cabeza tipada · §316: 61 -> 62, el testigo envia su cofirma al nodo · §319: 62 -> 66, la politica que nombra y la k que falla cerrada · §320: 66 -> 71, la recoleccion de cofirmas · §314: 71 -> 75, la ausencia de respuesta es una clase · §333: 75 -> 79, la clave de la serie pasa al indice embebido · §334: 79 -> 81, la marca solo se dispara sobre lo que prueba · §336: 81 -> 86, la politica del cofirmante sale de fn run y nace con tests · §337: 86 -> 91, el testigo vuelve a arrancar tras cofirmar · §404: 91 -> 92, otra version no se cree · §406: 92 -> 93, el testigo lee la version por VersionCabeza antes de la firma · §409: 93 -> 94, el mando de --respuesta y el texto del veredicto · §411: 94 -> 95, los KAT del nucleo · §414: 95 -> 96, el canal de la historia ve la v4 (RFC-0006, E2a) · §415: 96 -> 97, el diario custodia la pareja de consumos (RFC-0006, E2b)
zk-ssl-node        sello      95   0   0   400  alias=nodo · §261: 51 -> 56, la credencial para los caminos · §292: 79 -> 80, la cima en el digest · §293: 80 -> 82, la extension servida · §296: 82 -> 73, el guardian se muda a su crate · §298: 73 -> 71, la lectura del indice se muda · §302: 71 -> 72, el contrato publicado atado al despacho · §309: 72 -> 73, el conjunto de claves servidas, declarado · §315: 73 -> 76, el transporte de la cofirma · §317: 76 -> 77, la retencion de las cofirmas, atada · §318: 77 -> 80, el disparador de la acumulacion · §328: 80 -> 83, el arranque reconcilia · §331: 83 -> 84, la clave en cero no arranca · §335: 84 -> 91, la clave vuelve a su indice y el contador se ata al diario · §417: 91 -> 95, el consumo por el cable (RFC-0006, E3a)
zk-ssl-verify      sello      88   0   0   120  alias=verificador independiente · §257: 22 -> 23, del cable a la cabeza sin la capa · §291: 39 -> 46, el MMR de cabezas · §292: 46 -> 48, la cima en el digest · §297: 48 -> 55, el objeto de la cofirma · §322: 55 -> 61, las cofirmas dentro del paquete de evidencia · §324: 61 -> 62, la mudanza de COFIRMA_VERSION · §332: 62 -> 66, el indice declarado se ata al que va dentro de la firma · §335: 66 -> 69, el apano del OID pasa a tener un solo dueno · S395: 69 -> 72, la autonomia del verificador deja de ser prosa · §399: 72 -> 75, el indice declarado de la cabeza se ata al que va dentro de la firma · §406: 75 -> 79, el conjunto de versiones tiene un solo productor · §414: 79 -> 82, la cabeza v4 en el nucleo y el mando (RFC-0006, E2a) · §419: 82 -> 88, las reglas del arbol de consumos en el verificador (RFC-0006, E3b-2)
zk-ssl-hash        sello      27   0   0    60  §270: 14 -> 16, el acuse componible por un tercero · §292: 22 -> 24, la cima en el digest · §414: 24 -> 26, epoch_digest_v4 (RFC-0006, E2a) · §416: 26 -> 27, la posicion del consumo en el nucleo (RFC-0006, E3a)
