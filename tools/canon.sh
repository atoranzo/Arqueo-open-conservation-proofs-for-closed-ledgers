...
stark-experiment   sello     338  11   0   600  alias=circuitos · los circuitos · §345: 297 -> 299, el gemelo nativo v2 (RFC-0003, E1a) · §346: 299 -> 304, RefundAirV2 en paralelo (E2a del RFC-0003) · §347: 304 -> 310, ClaimAirV2 en paralelo (E2b del RFC-0003) · §348: 310 -> 312, la puerta de E2 saldada (ladron-con-aviso y tercero-como-retorno) · §352: 312 -> 318, el envio aprende el sobre (E3c-1a del RFC-0003) · §463: 318 -> 328, el probador de la prueba de edad (RFC-0007, E4b-1) · §465: 328 -> 330, la cabeza fija la marca y el seq de la prueba de edad (RFC-0007, E4b-2) · §477: 330 -> 337, el probador de la banda del saldo (RFC-0007, E5, corte 4a) · §478: 337 -> 338, la boca del probador de la banda (RFC-0007, E5, corte 4b)
...
zk-ssl-air         sello      10   0   0    60  §463: nace con 4, el AIR de la prueba de edad y su juez, sin el probador (RFC-0007, E4b-1) · §465: 4 -> 5, la m de una marca es la minima (RFC-0007, E4b-2) · §477: 5 -> 10, el AIR de la banda del saldo, sin titularidad (RFC-0007, E5, corte 4a)
