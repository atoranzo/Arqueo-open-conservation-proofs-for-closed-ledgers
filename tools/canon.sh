...
zk-ssl-wire        sello      10   0   0    60  §259: 20 metodos, y el json publicado atado a la tabla · §311: 3 -> 7, el DTO de la cabeza firmada · §312: 7 -> 10, el accesor falible de la cabeza firmada
