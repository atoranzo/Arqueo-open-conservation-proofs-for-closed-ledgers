...
zk-ssl-guardian    sello       25   0   0    60  §296: el guardian del indice, MUDADO del nodo (sus 9 tests salen del pin 82) · §298: 9 -> 11, y llega con sus dos tests de layout · §330: 11 -> 19, el lector comun de la semilla · §331: 19 -> 22, ClaveEnCero y su guarda · §335: 22 -> 25, el escritor del indice y su techo derivado del ancho
