...
zk-ssl-verify      sello      62   0   0   120  alias=verificador independiente · §257: 22 -> 23, del cable a la cabeza sin la capa · §291: 39 -> 46, el MMR de cabezas · §292: 46 -> 48, la cima en el digest · §297: 48 -> 55, el objeto de la cofirma · §322: 55 -> 61, las cofirmas dentro del paquete de evidencia · §324: 61 -> 62, la mudanza de COFIRMA_VERSION
