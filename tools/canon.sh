...
zk-ssl-air         sello      29   0   0    60  §463: nace con 4, el AIR de la prueba de edad y su juez, sin el probador (RFC-0007, E4b-1) · §465: 4 -> 5, la m de una marca es la minima (RFC-0007, E4b-2) · §477: 5 -> 10, el AIR de la banda del saldo, sin titularidad (RFC-0007, E5, corte 4a) · §490: 10 -> 15, el AIR del cobro pendiente, sin el probador (RFC-0008, E1) · §495: 15 -> 16, el enlace del cobro pendiente a la cabeza v5 (RFC-0008, E1) · §503: 16 -> 22, el AIR del pago en curso y sus seis testigos (RFC-0008, E2) · §516: 22 -> 29, el AIR de la prenda con su juez y su enlace, sin el probador (RFC-0008, E3)
