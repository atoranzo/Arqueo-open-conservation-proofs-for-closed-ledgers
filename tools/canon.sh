...
zk-ssl-node        sello      83   0   0   400  alias=nodo · §261: 51 -> 56, la credencial para los caminos · §292: 79 -> 80, la cima en el digest · §293: 80 -> 82, la extension servida · §296: 82 -> 73, el guardian se muda a su crate · §298: 73 -> 71, la lectura del indice se muda · §302: 71 -> 72, el contrato publicado atado al despacho · §309: 72 -> 73, el conjunto de claves servidas, declarado · §315: 73 -> 76, el transporte de la cofirma · §317: 76 -> 77, la retencion de las cofirmas, atada · §318: 77 -> 80, el disparador de la acumulacion · §328: 80 -> 83, el arranque reconcilia
...
zk-ssl-guardian    sello       19   0   0    60  §296: el guardian del indice, MUDADO del nodo (sus 9 tests salen del pin 82) · §298: 9 -> 11, y llega con sus dos tests de layout · §330: 11 -> 19, el lector comun de la semilla
