...
TABLA=$(cat <<'FIN_TABLA'
zk-ssl             sello     389   7   0   600  alias=capa · la capa · §292: 262 -> 263, la cima en el digest · §304: 263 -> 264, el atado de la cifra publicada · §340: 264 -> 265, la altura entra en el digest · §345: 265 -> 269, el compositor v2 (RFC-0003, E1a) · §350: 269 -> 272, el cobro aprende el sobre (E3b-1 del RFC-0003) · §351: 272 -> 276, la apertura en el recibo (E3b-2 del RFC-0003) · §353: 276 -> 279, la via viva aprende el sobre (E3c-1b del RFC-0003) · §355: 279 -> 284, la guarda de ancho llega a los gemelos · §357: 284 -> 285, el testigo funcional de la des-emision (deuda del §351) · §359: 285 -> 286, el export del snapshot falla cerrado · §362: 286 -> 287, el reloj sale del atado a su contrato propio · §379: 287 -> 289, la conservacion del dinero se comprueba al abrir · §387: 289 -> 292, la raiz del pendiente se guarda y se comprueba al abrir · §388: 292 -> 294, la raiz de meta del pendiente se guarda y se comprueba al abrir · §390: 294 -> 295, descongelar sobrevive al reinicio · §391: 295 -> 298, la raiz de congelados en reposo · §392: 298 -> 301, la raiz del registro en reposo · §393: 301 -> 304, los contadores custodiados los deriva el registro · §394: 304 -> 307, la cuota de custodios la deriva el registro · §413: 307 -> 317, el consumo publicado (RFC-0006, E1) · §415: 317 -> 318, la pareja de consumos en el digest (RFC-0006, E2b) · §416: 318 -> 323, el camino del consumo (RFC-0006, E3a) · §452: 323 -> 326, la familia de v5 en la cabeza de la capa (RFC-0007, E1b) · §454: 326 -> 329, la causa de un rechazo como dato (RFC-0007, E2) · §458: 329 -> 330, el camino de congelados en la capa (RFC-0007, E3b) · §461: 330 -> 335, el instrumento de la puerta de la prueba de edad (RFC-0007, E4a) · §463: 335 -> 337, la prueba de edad real sobre el libro de la capa (RFC-0007, E4b-1) · §465: 337 -> 340, la prueba de edad se enlaza a la cabeza del libro (RFC-0007, E4b-2) · §466: 340 -> 344, el productor de la prueba de edad (RFC-0007, E4b-3) · §474: 344 -> 345, el camino de cuentas y su atado (RFC-0007, E5, 3b) · §478: 345 -> 350, el productor de la banda del saldo (RFC-0007, E5, corte 4b) · §485: 350 -> 354, el instrumento del cobro pendiente portable (RFC-0008, E1) · §487: 354 -> 357, la no-congelacion la impone el aplicador, no la prueba (5.A-264, A) · §491: 357 -> 365, el productor del cobrador (RFC-0008, E1) · §492: 365 -> 372, la foto de los pendientes que toma el latido (RFC-0008, D-F) · §495: 372 -> 373, el enlace del cobro pendiente en el productor de la capa (RFC-0008, E1) · §502: 373 -> 378, el instrumento del pago en curso portable (RFC-0008, E2) · §504: 378 -> 389, el productor del pago en curso en la capa (RFC-0008, E2)
stark-experiment   sello     364  12   0   600  alias=circuitos · los circuitos · §345: 297 -> 299, el gemelo nativo v2 (RFC-0003, E1a) · §346: 299 -> 304, RefundAirV2 en paralelo (E2a del RFC-0003) · §347: 304 -> 310, ClaimAirV2 en paralelo (E2b del RFC-0003) · §348: 310 -> 312, la puerta de E2 saldada (ladron-con-aviso y tercero-como-retorno) · §352: 312 -> 318, el envio aprende el sobre (E3c-1a del RFC-0003) · §463: 318 -> 328, el probador de la prueba de edad (RFC-0007, E4b-1) · §465: 328 -> 330, la cabeza fija la marca y el seq de la prueba de edad (RFC-0007, E4b-2) · §477: 330 -> 337, el probador de la banda del saldo (RFC-0007, E5, corte 4a) · §478: 337 -> 338, la boca del probador de la banda (RFC-0007, E5, corte 4b) · §490: 338 -> 348, el probador del cobro pendiente (RFC-0008, E1) · §495: 348 -> 350, la cabeza fija las raices y el nacido del cobro (RFC-0008, E1) · §503: 350 -> 364, el probador del pago en curso y sus catorce (RFC-0008, E2)
...
zk-ssl-air         sello      22   0   0    60  §463: nace con 4, el AIR de la prueba de edad y su juez, sin el probador (RFC-0007, E4b-1) · §465: 4 -> 5, la m de una marca es la minima (RFC-0007, E4b-2) · §477: 5 -> 10, el AIR de la banda del saldo, sin titularidad (RFC-0007, E5, corte 4a) · §490: 10 -> 15, el AIR del cobro pendiente, sin el probador (RFC-0008, E1) · §495: 15 -> 16, el enlace del cobro pendiente a la cabeza v5 (RFC-0008, E1) · §503: 16 -> 22, el AIR del pago en curso y sus seis testigos (RFC-0008, E2)
