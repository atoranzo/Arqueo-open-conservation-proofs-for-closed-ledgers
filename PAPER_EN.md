...
The reference implementation comprises **1160 executable tests in the seal
gate** —1297 counting the pins of the long and complete levels, and 1314
...
cargo test -p zk-ssl --release              # layer: 357 tests (6 ignored)
