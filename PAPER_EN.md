...
The reference implementation comprises **1245 executable tests in the seal
gate** —1382 counting the pins of the long and complete levels, and 1349
...
cargo test -p zk-ssl --release              # layer: 389 tests (7 ignored)
cargo test -p stark-experiment --release    # circuits: 364 tests (12 ignored)
cargo test -p zk-ssl-node --release         # node: 112
