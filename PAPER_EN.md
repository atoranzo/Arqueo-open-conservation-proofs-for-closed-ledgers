...
The reference implementation comprises **1131 executable tests in the seal
gate** —1268 counting the pins of the long and complete levels, and 1284
...
cargo test -p zk-ssl --release              # layer: 345 tests (5 ignored)
