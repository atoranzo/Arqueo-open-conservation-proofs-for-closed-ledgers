...
The reference implementation comprises **1183 executable tests in the seal
gate** —1320 counting the pins of the long and complete levels, and 1338
...
cargo test -p zk-ssl --release              # layer: 365 tests (6 ignored)
cargo test -p stark-experiment --release    # circuits: 348 tests (12 ignored)
