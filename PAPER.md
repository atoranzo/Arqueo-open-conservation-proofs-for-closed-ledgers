...
La implementación de referencia consta de **986 pruebas ejecutables en la
compuerta de sello** —1123 contando los pines de los niveles largo y
completo, y 1137 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 292 tests (3 ignorados)
