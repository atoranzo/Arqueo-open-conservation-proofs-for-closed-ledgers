...
La implementación de referencia consta de **960 pruebas ejecutables en la
compuerta de sello** —1097 contando los pines de los niveles largo y
completo, y 1111 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 272 tests (3 ignorados)
