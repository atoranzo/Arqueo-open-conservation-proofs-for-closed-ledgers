...
La implementación de referencia consta de **1100 pruebas ejecutables en la
compuerta de sello** —1237 contando los pines de los niveles largo y
completo, y 1252 declaradas—, con 14 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 335 tests (4 ignorados)
cargo test -p stark-experiment --release    # circuitos: 318 tests (10 ignorados)
