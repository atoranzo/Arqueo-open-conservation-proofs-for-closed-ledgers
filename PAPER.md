...
La implementación de referencia consta de **980 pruebas ejecutables en la
compuerta de sello** —1117 contando los pines de los niveles largo y
completo, y 1131 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 286 tests (3 ignorados)
