...
La implementación de referencia consta de **1086 pruebas ejecutables en la
compuerta de sello** —1223 contando los pines de los niveles largo y
completo, y 1237 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 329 tests (3 ignorados)
cargo test -p stark-experiment --release    # circuitos: 318 tests (10 ignorados)
cargo test -p zk-ssl-node --release         # nodo: 104
