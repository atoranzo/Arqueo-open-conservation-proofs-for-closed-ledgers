...
La implementación de referencia consta de **983 pruebas ejecutables en la
compuerta de sello** —1120 contando los pines de los niveles largo y
completo, y 1134 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 289 tests (3 ignorados)
