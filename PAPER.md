...
La implementación de referencia consta de **992 pruebas ejecutables en la
compuerta de sello** —1129 contando los pines de los niveles largo y
completo, y 1143 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 298 tests (3 ignorados)
