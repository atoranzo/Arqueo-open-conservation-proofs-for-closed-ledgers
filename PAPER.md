...
La implementación de referencia consta de **1095 pruebas ejecutables en la
compuerta de sello** —1232 contando los pines de los niveles largo y
completo, y 1246 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 330 tests (3 ignorados)
