...
La implementación de referencia consta de **988 pruebas ejecutables en la
compuerta de sello** —1125 contando los pines de los niveles largo y
completo, y 1139 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 294 tests (3 ignorados)
