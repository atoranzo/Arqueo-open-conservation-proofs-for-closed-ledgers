...
La implementación de referencia consta de **1396 pruebas ejecutables en la
compuerta de sello** (55 son las de winterfell 0.13.1, que el fork del §533
trae consigo) —1533 contando los pines de los niveles largo y completo, y
...
cargo test -p stark-experiment --release    # circuitos: 394 tests (13 ignorados)
