...
La implementación de referencia consta de **938 pruebas ejecutables en la
compuerta de sello** —1075 contando los pines de los niveles largo y
completo, y 1089 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 265 tests (3 ignorados)
