...
La implementación de referencia consta de **995 pruebas ejecutables en la
compuerta de sello** —1132 contando los pines de los niveles largo y
completo, y 1146 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 301 tests (3 ignorados)
