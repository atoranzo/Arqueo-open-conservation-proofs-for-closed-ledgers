...
La implementación de referencia consta de **1214 pruebas ejecutables en la
compuerta de sello** —1351 contando los pines de los niveles largo y
...
cargo test -p zk-ssl --release              # capa: 378 tests (7 ignorados)
