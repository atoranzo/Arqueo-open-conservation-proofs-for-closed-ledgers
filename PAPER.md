...
La implementación de referencia consta de 266 pruebas ejecutables —más una ignorada, documentada— y
...
```bash
cargo test -p zk-ssl --release              # capa: 131 tests
cargo test -p stark-experiment --release    # circuitos: 135 tests
