...
La implementación de referencia consta de **1313 pruebas ejecutables en la
compuerta de sello** —1450 contando los pines de los niveles largo y
...
cargo test -p zk-ssl --release              # capa: 399 tests (7 ignorados)
cargo test -p stark-experiment --release    # circuitos: 391 tests (13 ignorados)
