...
La implementación de referencia consta de **1116 pruebas ejecutables en la
compuerta de sello** —1253 contando los pines de los niveles largo y
completo, y 1269 declaradas—, con 15 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 337 tests (5 ignorados)
cargo test -p stark-experiment --release    # circuitos: 328 tests (10 ignorados)
cargo test -p zk-ssl-node --release         # nodo: 108
