...
La implementación de referencia consta de **1190 pruebas ejecutables en la
compuerta de sello** —1327 contando los pines de los niveles largo y
completo, y 1345 declaradas—, con 18 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 372 tests (6 ignorados)
