...
La implementación de referencia consta de **979 pruebas ejecutables en la
compuerta de sello** —1116 contando los pines de los niveles largo y
completo, y 1130 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 285 tests (3 ignorados)
