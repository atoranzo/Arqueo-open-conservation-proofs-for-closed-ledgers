...
La implementación de referencia consta de **722 pruebas ejecutables en la
compuerta de sello** —859 contando los pines de los niveles largo y
completo, y 873 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 257 tests (3 ignorados)
