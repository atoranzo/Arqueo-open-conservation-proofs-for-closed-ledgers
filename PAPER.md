...
La implementación de referencia consta de **1153 pruebas ejecutables en la
compuerta de sello** —1290 contando los pines de los niveles largo y
completo, y 1306 declaradas—, con 16 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 350 tests (5 ignorados)
