...
La implementación de referencia consta de **1245 pruebas ejecutables en la
compuerta de sello** —1382 contando los pines de los niveles largo y
...
cargo test -p zk-ssl --release              # capa: 389 tests (7 ignorados)
cargo test -p stark-experiment --release    # circuitos: 364 tests (12 ignorados)
