...
La implementación de referencia consta de **782 pruebas ejecutables en la
compuerta de sello** —919 contando los pines de los niveles largo y
completo, y 933 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 259 tests (3 ignorados)
