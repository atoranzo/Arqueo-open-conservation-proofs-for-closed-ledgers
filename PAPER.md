...
La implementación de referencia consta de **998 pruebas ejecutables en la
compuerta de sello** —1135 contando los pines de los niveles largo y
completo, y 1149 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 304 tests (3 ignorados)
