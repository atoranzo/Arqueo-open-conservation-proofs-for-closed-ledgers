...
La implementación de referencia consta de **989 pruebas ejecutables en la
compuerta de sello** —1126 contando los pines de los niveles largo y
completo, y 1140 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 295 tests (3 ignorados)
