...
La implementación de referencia consta de **1126 pruebas ejecutables en la
compuerta de sello** —1263 contando los pines de los niveles largo y
completo, y 1279 declaradas—, con 15 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 340 tests (5 ignorados)
cargo test -p stark-experiment --release    # circuitos: 330 tests (10 ignorados)
