...
La implementación de referencia consta de **981 pruebas ejecutables en la
compuerta de sello** —1118 contando los pines de los niveles largo y
completo, y 1132 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 287 tests (3 ignorados)
