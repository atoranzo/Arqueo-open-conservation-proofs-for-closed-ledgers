...
La implementación de referencia consta de **1130 pruebas ejecutables en la
compuerta de sello** —1267 contando los pines de los niveles largo y
completo, y 1283 declaradas—, con 15 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 344 tests (5 ignorados)
