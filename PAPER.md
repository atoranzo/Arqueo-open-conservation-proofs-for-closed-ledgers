...
La implementación de referencia consta de **1045 pruebas ejecutables en la
compuerta de sello** —1182 contando los pines de los niveles largo y
completo, y 1196 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 323 tests (3 ignorados)
