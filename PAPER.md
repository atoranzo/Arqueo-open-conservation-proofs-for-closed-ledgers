...
La implementación de referencia consta de **1080 pruebas ejecutables en la
compuerta de sello** —1217 contando los pines de los niveles largo y
completo, y 1231 declaradas—, con 13 ignoradas y declaradas, y
...
cargo test -p zk-ssl --release              # capa: 326 tests (3 ignorados)
cargo test -p stark-experiment --release    # circuitos: 318 tests (10 ignorados)
cargo test -p zk-ssl-node --release         # nodo: 101
