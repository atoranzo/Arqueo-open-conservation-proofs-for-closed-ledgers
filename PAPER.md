...
La implementación de referencia consta de 372 pruebas ejecutables —más una ignorada, documentada— y
...
cargo test -p stark-experiment --release    # circuitos: 200 tests
