...
| **Protocol `zkssl/0.3`**: 26 JSON-RPC methods (24 `zkssl_*`, 2 `dev_*`), OpenRPC generated from the code, vectors per version that are never rewritten | [`spec/RPC.md`](./spec/RPC.md) · [`spec/openrpc.json`](./spec/openrpc.json) · [`spec/vectors/`](./spec/vectors/) (192 files: cable, núcleo, paquete, consumo, conflicto, rechazo and the three `zkssl-0.N.json`) |
