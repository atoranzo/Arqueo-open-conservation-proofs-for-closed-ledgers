...
| **Protocol `zkssl/0.4`**: 30 JSON-RPC methods (27 `zkssl_*`, 3 `dev_*`), OpenRPC generated from the code, vectors per version that are never rewritten | [`spec/RPC.md`](./spec/RPC.md) · [`spec/openrpc.json`](./spec/openrpc.json) · [`spec/vectors/`](./spec/vectors/) (313 files: cable, núcleo, paquete, consumo, conflicto, rechazo, edad, pendiente, pago, prenda, the 0.3 catalogues under `0.3/` and the four `zkssl-0.N.json`) |
| **RFCs**: 0002, 0003, 0004, 0006, 0007 (proofs over the committed state) and 0009 (what a proof reveals) accepted; 0005 (the frozen core) and 0008 (the portable proofs of a pending item) proposed | [`spec/rfc/`](./spec/rfc/) |
