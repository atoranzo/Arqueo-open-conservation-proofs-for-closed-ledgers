...
| **RFCs**: 0002, 0003, 0004, 0006, 0007 (proofs over the committed state), 0008 (the portable proofs of a pending item) and 0009 (what a proof reveals) accepted; 0005 (the frozen core) proposed | [`spec/rfc/`](./spec/rfc/) |
