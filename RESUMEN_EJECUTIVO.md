...
| El protocolo | `zkssl/0.4`: 29 métodos JSON-RPC, vectores de conformidad por versión que jamás se reescriben; RFC 0002-0004, 0006, 0007, 0009 aceptados; 0005, 0008 propuestos |
