...
**973 tests en la compuerta de sello** —1110 con todos los pines, 1124
...
(**`zkssl/0.3`** desde §354; la `0.2` rigió desde §209, 17 métodos) · `spec/openrpc.json` **generado** desde el
